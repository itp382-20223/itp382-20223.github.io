...
## PooledObject.cs
When you want to make an **ObjectPool** out of something, use **PooledObject** as a baseclass to keep track of which **ObjectPool** it came from.
...
**SpawnPools** as a public getter `SpawnPools.Get()` to make it accessible from anywhere.\
