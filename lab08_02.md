...
The buildings are stored in the array `m_grid` with a reverse lookup table in `m_objects`. This makes it easy to what object is in what location and what location each object is in.\
